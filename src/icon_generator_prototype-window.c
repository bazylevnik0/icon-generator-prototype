...
icon_generator_prototype_window_class_init (IconGeneratorPrototypeWindowClass *klass)
{
  ...
  gtk_widget_class_bind_template_child (widget_class, IconGeneratorPrototypeWindow, header_bar);
  gtk_widget_class_bind_template_child (widget_class, IconGeneratorPrototypeWindow, label);
}
